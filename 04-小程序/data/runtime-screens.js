/* 运行时挂进 SCREENS 的那些屏，集中在这里挂一次。
   ...
   `index.js` 的 onLoad 会挂它们，而 gen.mjs / chk.mjs / shot.mjs
   三个工具各自 require 原始数据，看不到这些屏。
   （ia.mjs 是第四个，2026-08-29 随非提交物一起移出参赛仓库，在 _工作过程/ 里）
   前两轮的做法是**在每个工具里各抄一遍挂载代码**——加一组屏就要改好几个地方，
