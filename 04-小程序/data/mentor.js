...
const MENTORS = [
  { id: 'dbt', name: '岸', tag: '先过这一阵',
    ...
    lead: '她给的都是马上能做的小动作——接一杯水、换一把椅子、把手放到凉的地方。做完一件，这一阵就过去一些。她不分析，也不追问。' },
  { id: 'cbt', name: '回声', tag: '那句话是谁说的',
    intro: '把你心里那句话拎出来，放在桌上听一听。',
    lead: '她会引用你刚说的那句，问它是一件正在发生的事，还是一个说法。有时会问那是谁的声音、从哪儿学来的。她不给动作，也不安慰。' },
  { id: 'act', name: '同路', tag: '不用先感觉好',
    intro: '难受可以一直在，你也可以同时往前走一点。',
    lead: '她从不劝你想开、放下。她说的是：一边这么难受，一边仍然可以去做本来要做的事。她也会点出你正在等的那个条件，然后说不用等。' },
  { id: 'body', name: '地面', tag: '此刻的身体',
    intro: '只问你身上现在什么感觉。',
    lead: '手是凉的还是温的，肩膀端着没有，脚有没有踩实。她只问当下的身体，不问过去，不解释道理。她说得比谁都短。' },
];
...
const CASES = [
  ...
  },
  {
    ...
    /* 不敢让人看见。对应藏食那条亲历输入与照护者端。
       ⚠️ 不劝她说出来——「产品不制造动机」。 */
    title: '不敢让人知道',
    cue: ['被发现了怎么办', '不敢让人看见', '躲着吃', '怕她问', '不想说'],
    say: {
      dbt: '不用今天就决定要不要说。\n先把门关上，自己待一会儿。\n藏着这件事很累，那个累是真的。',
