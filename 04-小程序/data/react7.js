...
const REACT = [
  { id: 'rhino', nav: '想把道理讲清楚', animal: '犀牛', ideal: false,
    look: '她说不吃，你就解释为什么必须吃。她躲开，你就追上去接着说。你说的每一句都是对的。',
    cost: '正在发生的时候讲道理，她听到的不是道理，是「你又要跟我吵」。',
    swap: '这一刻不谈。要谈，挑一个不挨着饭桌、也不挨着卫生间的时间。' },
  { id: 'terrier', nav: '忍不住一直提', animal: '梗犬', ideal: false,
    look: '每隔一会儿问一句「你吃了吗」。你知道自己在重复，但不问更难受。',
    cost: '提醒的次数越多，她越需要藏。你想制止的那个行为，正在被你的关心推着往隐蔽处走。',
    swap: '一天只说一次。说完就走开，不等回答。' },
  { id: 'ostrich', nav: '看见了但装作没看见', animal: '鸵鸟', ideal: false,
    look: '垃圾里有包装，饭后卫生间里的水声。你都看见了，但不知道从哪儿开口，于是当作没看见。',
    cost: '沉默不会让它停下来，只会让它更省事。而且她多半知道你看见了。',
    swap: '不用先弄清全部。只说你看见的一件事，不带评价，也不问是不是。' },
  { id: 'kangaroo', nav: '把所有难都替她挡掉', animal: '袋鼠', ideal: false,
    look: '不让她做饭，不让她面对聚餐，替她解释，替她拒绝。你宁可自己累。',
    cost: '挡得越干净，她越没有机会发现自己其实应付得来。',
    swap: '留一件她能自己做的小事，哪怕做得不好。' },
  { id: 'jelly', nav: '自己先撑不住', animal: '水母', ideal: false,
    look: '她的病让你愤怒、害怕、半夜睡不着、忍不住哭。',
    cost: '这些情绪她全都收得到，然后还给你同样的失控。你们会在同一个情绪里越转越紧。',
    swap: '先管你自己那一份。你稳一点，她才有一个稳的地方可以靠。' },
  { id: 'dolphin', nav: '在旁边一起走', animal: '海豚', ideal: true,
    look: '不在前面拉，不在后面推。她慢，你就慢；她停下来，你就在旁边站一会儿再说话。',
    swap: '温和地推一下就够了，一次一下。方向由她定。' },
  { id: 'stbernard', nav: '不慌', animal: '圣伯纳犬', ideal: true,
    look: '她最需要的不是有人替她着急，<br>是有人不慌。',
